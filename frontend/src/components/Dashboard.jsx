...
const Dashboard = ({ analysisData, onClearAnalysis }) => {
  ...
  const getRSIStatus = (rsi) => {
    if (rsi >= 70) {
      return { status: 'Overbought', color: 'text-orange-600', bg: 'bg-orange-50' };
    }
    if (rsi <= 30) {
      return { status: 'Oversold', color: 'text-blue-600', bg: 'bg-blue-50' };
    }
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-gray-200">
            ...
            <CardContent>
              ...
              <div
                className={`mt-2 inline-block px-2 py-1 rounded text-xs font-medium ${rsiStatus.bg} ${rsiStatus.color}`}
              >
                {rsiStatus.status}
              </div>
            </CardContent>
              ...
              <ResponsiveContainer width="100%" height={250}>
                <LineChart data={charts.rsi}>
                  ...
                  <ReferenceLine
                    ...
                    stroke="#ef4444"
                    strokeDasharray="3 3"
                    label={{ value: 'Overbought (70)', position: 'right', fill: '#ef4444', fontSize: 10 }}
                  />
                  <ReferenceLine
                    y={30}
                    stroke="#3b82f6"
                    strokeDasharray="3 3"
                    label={{ value: 'Oversold (30)', position: 'right', fill: '#3b82f6', fontSize: 10 }}
                  />
                  <Line
                    type="monotone"
                    dataKey="rsi"
